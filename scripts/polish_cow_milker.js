...
function saveGame() {
	var parameters = "milk=" + milk + "&milkers=" + milker.amount + "&slaves=" + slave.amount;
	ajax.open("POST", "../../php/polish_save.php");
	ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajax.send(parameters);
	var text = document.getElementById("save_game_text").style;
	text.visibility = "visible";
  setTimeout(function(){text.visibility = "hidden"},1000)
}

window.setInterval(saveGame, 6000);
