...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2290211451ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=evenquiz&table=polishcowmilkerstats">`evenquiz`.`polishcowmilkerstats`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=evenquiz&table=evenquizquestions">`evenquiz`.`evenquizquestions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=evenquiz&table=evenquizstats">`evenquiz`.`evenquizstats`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=evenquiz&table=faqs">`evenquiz`.`faqs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=evenquiz&table=users">`evenquiz`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6668253a3875462536303e5449233b3a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="evenquiz" targettable="evenquizquestions">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `evenquizquestions`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="evenquiz" targettable="evenquizquestions">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `evenquizquestions`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="evenquiz" targettable="evenquizstats">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `evenquizstats`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="evenquiz" targettable="polishcowmilkerstats">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `polishcowmilkerstats`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="evenquiz" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `evenquizstats`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="evenquiz" targettable="faqs">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `faqs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="evenquiz" targettable="evenquizstats">
                            <div class="action_content">
